...
// 加密的API名 (XOR 0x7F)
var (
	encCTQT    = []byte{0x3C, 0x0D, 0x1A, 0x1E, 0x0B, 0x1A, 0x28, 0x16, 0x12, 0x1A, 0x0D, 0x2E, 0x0A, 0x1A, 0x0A, 0x1A, 0x28, 0x16, 0x12, 0x1A, 0x0D} // CreateTimerQueueTimer
	encWFSO    = []byte{0x28, 0x1E, 0x16, 0x0B, 0x39, 0x10, 0x0D, 0x38, 0x16, 0x11, 0x18, 0x13, 0x1A, 0x2E, 0x1D, 0x17, 0x1A, 0x38, 0x0B}                         // WaitForSingleObject
	encCTE     = []byte{0x3C, 0x0D, 0x1A, 0x1E, 0x0B, 0x1A, 0x3A, 0x0A, 0x1A, 0x11, 0x0B}                                                                           // CreateEvent
)
